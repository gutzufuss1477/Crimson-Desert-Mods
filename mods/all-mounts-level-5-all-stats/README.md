...
Patch 2.03.02 retains the path but moves its code location by `0x80` bytes. The plugin is not hardcoded to Rokade or Character ID 31378. It targets the compatible
